...
// @version      1.2.0.0
// @description  Does the Same as the unclosed Request Review Script but also hides reports and feedbacks by/for Natty once the reported post is deleted.
// @author       @TinyGiant @rene @mogsdad @Makyen @Filnor
